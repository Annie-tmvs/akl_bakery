<div class="col-lg-12 con1">
    <div class="contaainer-fluid">
        <div class="container">
            <img src="<?php echo e(asset('assets/image/14.jpg')); ?>" class="rounded float-start img" alt="...">
            <h1>Welcome</h1>
...
<div class="col-lg-12 con2">
    <div class="contaainer-fluid">
        <div class="container">
            <img src="<?php echo e(asset('assets/image/17.jpg')); ?>" class="rounded-pill float-end img1" alt="...">
            ...
            <br>
            <img src="<?php echo e(asset('assets/image/17.1.jpg')); ?>" class="rounded-pill imgs" alt="...">
            <img src="<?php echo e(asset('assets/image/17.4.jpg')); ?>" class="rounded-pill imgs" alt="...">
            <img src="<?php echo e(asset('assets/image/17.3.jpg')); ?>" class="rounded-pill imgs" alt="...">
            <br>
...
<div class="col-lg-12 con3">
    <div class="contaainer-fluid">
        <div class="container">
            <img src="<?php echo e(asset('assets/image/18.jpg')); ?>" class="rounded-3 " alt="..." style="width: 20%;">
            <img src="<?php echo e(asset('assets/image/19.jpg')); ?>" class="rounded-3 " alt="..." style="width: 20%;">
            <img src="<?php echo e(asset('assets/image/20.jpg')); ?>" class="rounded-3 " alt="..." style="width: 20%;">
            <br>
...
<?php /**PATH C:\xampp\htdocs\AKL-Bakery\resources\views/layouts/inc/main.blade.php ENDPATH**/ ?>