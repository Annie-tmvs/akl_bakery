...
Route::get('view-category/{slug}', [FrontendController::class, 'showcategory']);
...
Route::post('delete-item', [CartController::class, 'deleteProduct']);
Route::post('update-item', [CartController::class, 'updatecart']);
